...
for y in years:
    p_name = pop_path + 'ssp2_' + str(y) + '_04population_mf_BIASCORR4.nc'
    m_name = mor_path + 'ref_' + str(y) + '_04_totalmor_mf_BIASCORR3.nc'
...
path_indyears = '/nfs/a321/earsch/CHAMNHA/output/annual_mortality/coeff_1/thres_hismodel/future/'
path_e = '/nfs/a321/earsch/CHAMNHA/output/e/coeff_1/future/'
...
for i in np.arange(0, len(dec_start)):
    ...
    for j in np.arange(0, len(tas_years)):
        ...
        save_name = sim  + '_' + tp.gcm(ahd_mean) + '_' + period + '_' + 'PBC4' + '_' + 'MBC3'
