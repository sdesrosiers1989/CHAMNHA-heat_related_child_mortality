...
#Coeff
coeff = place_holder(tas[0][0], 1.0) 
...
#saev path    
path = '/nfs/a321/earsch/CHAMNHA/output/annual_avg_mortality/coeff_1/'
...
ann_avg_heat_death = iris.cube.CubeList()
for cube in tdif_hislist:
    ...
    save_name = tp.gcm(ahd) + '_' + tp.model(ahd) + '_' + sim
    print(save_name)
    save_path = spath + save_name + '.nc'
    iris.save(ahd, save_path)
    
    ann_avg_heat_death.append(ahd)
