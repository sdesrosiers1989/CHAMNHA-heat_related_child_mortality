...
# 0 - 4 year olds
pop_2000 = iris.load_cube('/nfs/a321/earsch/CHAMNHA/input_data/pop/future/processed/ssp2_2000_04population_mf_BIASCORR4.nc')
pop_2010 = iris.load_cube('/nfs/a321/earsch/CHAMNHA/input_data/pop/future/processed/ssp2_2010_04population_mf_BIASCORR4.nc')
pop_2019 = iris.load_cube('/nfs/a321/earsch/CHAMNHA/input_data/pop/future/processed/ssp2_2020_04population_mf_BIASCORR4.nc')

#daily mortality
dmor_2000 = iris.load_cube('/nfs/a321/earsch/CHAMNHA/input_data/mortality/future/processed/ref_2000_04_totalmor_mf_BIASCORR3.nc')
dmor_2010 = iris.load_cube('/nfs/a321/earsch/CHAMNHA/input_data/mortality/future/processed/ref_2010_04_totalmor_mf_BIASCORR3.nc')
dmor_2019 = iris.load_cube('/nfs/a321/earsch/CHAMNHA/input_data/mortality/future/processed/ref_2020_04_totalmor_mf_BIASCORR3.nc')

dmor_2000 = dmor_2000 / 365.
dmor_2010 = dmor_2010 / 365.
dmor_2019 = dmor_2019 / 365.
