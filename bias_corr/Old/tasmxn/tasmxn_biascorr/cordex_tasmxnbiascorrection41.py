...
#tasmax
path = '/nfs/a321/earsch/Tanga/Data/CORDEX/Processed/tasmax_allyears/'
...
for file in filenames:
    if ('p25' in file) or ('cp4' in file):
        ...
        if 'historical' in file:
            ...
            tasmax.append(x)
#add rcp45
path = '/nfs/a321/earsch/Tanga/Data/CORDEX/Processed/tasmax_rcp45/'
filenames = glob.glob(path + '*.nc')
for file in filenames:
    x = iris.load_cube(file,  tasmax_constraint, callback = add_att_from_filename_tas45)
    tasmax.append(x)
  
#tasmin
path = '/nfs/a321/earsch/Tanga/Data/CORDEX/Processed/tasmin_allyears/'
filenames = glob.glob(path + '*.nc')
...
#add rcp45
path = '/nfs/a321/earsch/Tanga/Data/CORDEX/Processed/tasmin_rcp45/'
filenames = glob.glob(path + '*.nc')
for file in filenames:
    x = iris.load_cube(file,  tasmin_constraint, callback = add_att_from_filename_tas45)
    tasmin.append(x)
...
if var == 'tasmax':
    ...
    cru_tas = cru_tmax
    #save path
    path = '/nfs/a321/earsch/Tanga/Data/CORDEX/Bias_corr/CHAMNHA/tasmax/'
elif var == 'tasmin':
    tas_his = tasmin_his
    tas = tasmin
    cru_tas = cru_tmax
    #save path
    path = '/nfs/a321/earsch/Tanga/Data/CORDEX/Bias_corr/CHAMNHA/tasmin/'
