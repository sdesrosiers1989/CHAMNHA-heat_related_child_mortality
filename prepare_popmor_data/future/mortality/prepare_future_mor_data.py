...
#%% GBD future mortality

total_mor_2019 = np.nansum(mor_2019.data) / 1000 # GBD in 100s

d2016 = 54698.58

year = np.array([2016, 2040, 2040, 2040])
scen = np.array(['his', 'ref', 'better', 'worse'])
deaths = np.array([54698.58, 75263.26, 62570.88, 96717.00])
deaths_per_2016 = deaths/d2016

deaths_df = pd.DataFrame(data = {'year': year,
                                 'scen': scen,
                                 'deaths': deaths,
                                 'deaths_per_2016':deaths_per_2016})
